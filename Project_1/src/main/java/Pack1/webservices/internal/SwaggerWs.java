package Pack1.webservices.internal;
...
import Pack1.services.configuration.ConfigurationService;
...
public class SwaggerWs {
	...
	public SwaggerWs(ConfigurationService configurationService) {
		...
		beanConfig.setResourcePackage("Pack1.webservices.api");
		beanConfig.setBasePath("/api");
		beanConfig.setTitle("API Project_1");
